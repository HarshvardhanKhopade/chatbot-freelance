...
class ProductAdmin(admin.ModelAdmin):
    list_display = ("name", "category", "price", "best_seller")  # columns jo dikhenge
...
#     list_display = ("customer_name", "contact", "product", "quantity", "created_at")
#     search_fields = ("customer_name", "contact", "product__name")
#     list_filter = ("created_at",)

# ✅ Product Admin
@admin.register(Product)
class ProductAdmin(admin.ModelAdmin):
    list_display = ("id", "name", "price", "category")   # List view columns
    list_filter = ("category",)                         # Sidebar filters
    search_fields = ("name", "description", "category") # Search bar
